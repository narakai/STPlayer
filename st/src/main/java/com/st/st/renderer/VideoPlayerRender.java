...
import com.st.st.R;
import com.st.st.renderer.util.BufferUtil;
import com.st.st.renderer.util.TextureUtil;
...
public class VideoPlayerRender extends BaseGLSurfaceViewRenderer {
    ...
    public VideoPlayerRender(@NonNull Context context, GLSurfaceView surfaceView) {
        mContext = context;
